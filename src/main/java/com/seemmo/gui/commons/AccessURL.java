...
//        accessUrlLabel.setBounds(BaseConstant.CONST20, BaseConstant.CONST20, BaseConstant.CONST100, BaseConstant.CONST40);
        accessUrlLabel.setBounds(ScreenSize.widthRatio(0.0100), ScreenSize.heightRatio(0.0200), ScreenSize.widthRatio(0.0520), ScreenSize.heightRatio(0.0370));
        //accessUrlText
...
//        accessUrlText.setBounds(BaseConstant.CONST120, BaseConstant.CONST20, BaseConstant.CONST500, BaseConstant.CONST40);
        accessUrlText.setBounds(ScreenSize.widthRatio(0.0625), ScreenSize.heightRatio(0.0200), ScreenSize.widthRatio(0.2704), ScreenSize.heightRatio(0.0370));
    }//私有化构造方法使得该类无法在外部通过new 进行实例化
    public static AccessURL instance = new AccessURL();//准备一个类属性，指向一个实例化对象。 因为是类属性，所以只有一个

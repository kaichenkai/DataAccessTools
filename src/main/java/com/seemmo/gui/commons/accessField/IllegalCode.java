...
public class IllegalCode extends BaseField{
    ...
    private IllegalCode(){
        ...
        label.setBounds(BaseConstant.CONST20, BaseConstant.CONST440, BaseConstant.CONST100, BaseConstant.CONST30);
        //illegalCodeIndex
        ...
        index.setBounds(BaseConstant.CONST140, BaseConstant.CONST440, BaseConstant.CONST120, BaseConstant.CONST30);
        ...
        defaultValue.setBounds(BaseConstant.CONST300, BaseConstant.CONST440, BaseConstant.CONST90, BaseConstant.CONST30);
